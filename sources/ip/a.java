...
public abstract class a {
    ...
    public static d b(Context context) {
        ...
        try {
            ...
            if (!a(packageManager.getPackageInfo(a10, 64))) {
                return d.f20473f;
            }
            try {
                Resources resourcesForApplication = context.getPackageManager().getResourcesForApplication(a10);
                if (a10.equals("com.google.android.youtube.googletvdev")) {
                ...
                if (identifier != 0 && 12 <= resourcesForApplication.getInteger(identifier) / 100) {
                    if (!packageManager.getApplicationInfo(a10, 0).enabled) {
                        return d.f20472e;
                    }
                    return d.f20468a;
                }
