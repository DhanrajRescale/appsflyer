...
public final class y3 {
    ...
    public final Object a(float f10) {
        Object next;
        Iterator it = this.f27137a.entrySet().iterator();
        if (!it.hasNext()) {
            next = null;
        } else {
            next = it.next();
    ...
    public final float c(Object obj) {
        Float f10 = (Float) this.f27137a.get(obj);
        if (f10 != null) {
    ...
    public final boolean equals(Object obj) {
        ...
        return Intrinsics.a(this.f27137a, ((y3) obj).f27137a);
    }

    public final int hashCode() {
        return this.f27137a.hashCode() * 31;
    }

    public final String toString() {
        return "MapDraggableAnchors(" + this.f27137a + ')';
    }
}
