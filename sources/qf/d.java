...
public final class d extends i implements Function2 {
    ...
    public final /* synthetic */ MaintenanceWindowViewModel f31947b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(MaintenanceWindowViewModel maintenanceWindowViewModel, yt.a aVar) {
        super(2, aVar);
        this.f31947b = maintenanceWindowViewModel;
    }

    @Override // au.a
    public final yt.a create(Object obj, yt.a aVar) {
        return new d(this.f31947b, aVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        MaintenanceWindowViewModel maintenanceWindowViewModel = this.f31947b;
        try {
            if (i10 != 0) {
                if (i10 == 1) {
                    n.b(obj);
                ...
                n.b(obj);
                UserRepository userRepository = maintenanceWindowViewModel.f9081d;
                this.f31946a = 1;
            ...
            if (v0Var.f29302a.isSuccessful() && (maintenanceResponseV2 = (MaintenanceResponseV2) v0Var.f29303b) != null && (androidMaintenanceConfig = maintenanceResponseV2.getAndroidMaintenanceConfig()) != null && (config = androidMaintenanceConfig.getSections()) != null) {
                a aVar2 = maintenanceWindowViewModel.f9612n;
                aVar2.getClass();
                Intrinsics.checkNotNullParameter(config, "config");
                aVar2.f31926b = config;
                if (!maintenanceWindowViewModel.f9612n.b(maintenanceWindowViewModel.f9613o)) {
                    maintenanceWindowViewModel.f9614p.postValue(new j(Unit.f23355a));
                }
            }
        } catch (Exception e10) {
