...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sslSocket, boolean isFallback) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            tlsVersionsIntersection = Util.intersect(enabledProtocols, this.tlsVersionsAsString, xt.a.b());
        } else {
    ...
    public final boolean isCompatible(@NotNull SSLSocket socket) {
        ...
        if (strArr != null && !Util.hasIntersection(strArr, socket.getEnabledProtocols(), xt.a.b())) {
            return false;
        }
    ...
    public String toString() {
        ...
        return e.k(sb2, this.supportsTlsExtensions, ')');
    }
}
