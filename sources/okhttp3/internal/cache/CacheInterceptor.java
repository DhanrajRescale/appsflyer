...
public final class CacheInterceptor implements Interceptor {
    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers cachedHeaders, Headers networkHeaders) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if ((!s.j("Warning", name, true) || !s.r(value, "1", false)) && (isContentSpecificHeader(name) || !isEndToEnd(name) || networkHeaders.get(name) == null)) {
        ...
        private final boolean isContentSpecificHeader(String fieldName) {
            if (s.j("Content-Length", fieldName, true) || s.j("Content-Encoding", fieldName, true) || s.j("Content-Type", fieldName, true)) {
                return true;
            }
            return false;
        }
        ...
        private final boolean isEndToEnd(String fieldName) {
            if (!s.j("Connection", fieldName, true) && !s.j("Keep-Alive", fieldName, true) && !s.j("Proxy-Authenticate", fieldName, true) && !s.j("Proxy-Authorization", fieldName, true) && !s.j("TE", fieldName, true) && !s.j("Trailers", fieldName, true) && !s.j("Transfer-Encoding", fieldName, true) && !s.j("Upgrade", fieldName, true)) {
                return true;
            }
            return false;
        }
    ...
    private final Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        i0 body = cacheRequest.getBody();
        ResponseBody body2 = response.body();
        Intrinsics.c(body2);
        final l bodySource = body2.getBodySource();
        final d0 u10 = f.u(body);
        k0 k0Var = new k0() { // from class: okhttp3.internal.cache.CacheInterceptor$cacheWritingResponse$cacheWritingSource$1
            ...
            public long read(@NotNull j sink, long byteCount) throws IOException {
                ...
                try {
                    ...
                    sink.d(sink.f7365b - read, u10.h(), read);
                    u10.t();
                    return read;
        ...
        return response.newBuilder().body(new RealResponseBody(Response.header$default(response, "Content-Type", null, 2, null), response.body().getContentLength(), f.v(k0Var))).build();
    }
