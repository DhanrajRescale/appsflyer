...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    private final boolean verifySignature(X509Certificate toVerify, X509Certificate signingCert) {
        if (!Intrinsics.a(toVerify.getIssuerDN(), signingCert.getSubjectDN())) {
            return false;
        }
        try {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BasicCertificateChainCleaner) && Intrinsics.a(((BasicCertificateChainCleaner) other).trustRootIndex, this.trustRootIndex)) {
            return true;
        }
        return false;
    }
