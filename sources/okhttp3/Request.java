...
public final class Request {
    ...
    public static class Builder {
        ...
        @NotNull
        public Builder method(@NotNull String method, RequestBody body) {
            Intrinsics.checkNotNullParameter(method, "method");
            if (method.length() > 0) {
                if (body == null) {
                    if (!(!HttpMethod.requiresRequestBody(method))) {
                        throw new IllegalArgumentException(d.k("method ", method, " must have a request body.").toString());
                    }
                } else if (!HttpMethod.permitsRequestBody(method)) {
                    throw new IllegalArgumentException(d.k("method ", method, " must not have a request body.").toString());
                }
                this.method = method;
                this.body = body;
                return this;
        ...
        @NotNull
        public <T> Builder tag(@NotNull Class<? super T> type, T tag) {
        ...
        public Builder(@NotNull Request request) {
            ...
            if (request.getTags$okhttp().isEmpty()) {
                ...
                m10 = p0.m(request.getTags$okhttp());
            }
            this.tags = m10;
        ...
        if (this.headers.size() != 0) {
            ...
            for (Pair<? extends String, ? extends String> pair : this.headers) {
                ...
                if (i10 >= 0) {
                    ...
                    String str = (String) pair2.f23353a;
                    String str2 = (String) pair2.f23354b;
                    if (i10 > 0) {
                        sb2.append(", ");
                    }
                    sb2.append(str);
