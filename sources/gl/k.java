...
public abstract class k {
    ...
    public static final String a(String str) {
        int read;
        BufferedInputStream bufferedInputStream = new BufferedInputStream(new FileInputStream(new File(str)), UserMetadata.MAX_ATTRIBUTE_SIZE);
        try {
            ...
            yk.g.k(bufferedInputStream, null);
            return bigInteger;
        } finally {
        }
    }
    ...
    public static final String b(Context context) {
        ...
        try {
            ...
            Object newProxyInstance = Proxy.newProxyInstance(k.class.getClassLoader(), new Class[]{cls}, new j(obj, zVar, reentrantLock, newCondition));
            ...
            method.invoke(context.getPackageManager(), context.getPackageName(), Boolean.FALSE, obj, g0.S(S), newProxyInstance);
            newCondition.await();
            String str = (String) zVar.f20560a;
