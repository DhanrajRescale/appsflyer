...
public final class us extends ts {
    ...
    public static final SparseIntArray f6355v;
    ...
    static {
        ...
        f6355v = sparseIntArray;
        sparseIntArray.put(R.id.label_under_review, 2);
    ...
    */
    public us(android.view.View r6) {
        /*
            r5 = this;
            android.util.SparseIntArray r0 = ba.us.f6355v
            r1 = 4
            r2 = 0
            ...
            r0.setTag(r2)
            android.widget.TextView r0 = r5.f6224s
            r0.setTag(r2)
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ba.us.<init>(android.view.View):void");
    }
    ...
    public final void b() {
        ...
        MissionHistoryViewModel missionHistoryViewModel = this.f6225t;
        long j11 = j10 & 7;
        int i10 = 0;
        if (j11 != 0) {
            ...
            if (missionsHistoryConsolidated != null) {
                i10 = missionsHistoryConsolidated.getInReview();
            }
        }
        if (j11 != 0) {
            TextView textView = this.f6224s;
