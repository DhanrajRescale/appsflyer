...
public final class ap extends zo {
    ...
    public static final h.c f4215y;

    /* renamed from: z, reason: collision with root package name */
    public static final SparseIntArray f4216z;
    ...
    static {
        h.c cVar = new h.c(7);
        f4215y = cVar;
        cVar.W(0, new int[]{1}, new int[]{R.layout.content_stock_short_sell_order}, new String[]{"content_stock_short_sell_order"});
    ...
    */
    public ap(android.view.View r10) {
        /*
            r9 = this;
            r1 = 0
            h.c r0 = ba.ap.f4215y
            android.util.SparseIntArray r2 = ba.ap.f4216z
            r3 = 7
        ...
        L3c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ba.ap.<init>(android.view.View):void");
    }
