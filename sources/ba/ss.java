...
public final class ss extends rs {
    ...
    public static final SparseIntArray f6126v;
    ...
    static {
        ...
        f6126v = sparseIntArray;
        sparseIntArray.put(R.id.label_failed, 2);
    ...
    */
    public ss(android.view.View r6) {
        /*
            r5 = this;
            android.util.SparseIntArray r0 = ba.ss.f6126v
            r1 = 4
            r2 = 0
            ...
            r0.setTag(r2)
            android.widget.TextView r0 = r5.f6003s
            r0.setTag(r2)
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ba.ss.<init>(android.view.View):void");
    }
    ...
    public final void b() {
        ...
        MissionHistoryViewModel missionHistoryViewModel = this.f6004t;
        long j11 = j10 & 7;
        int i10 = 0;
        if (j11 != 0) {
            ...
            if (missionsHistoryConsolidated != null) {
                i10 = missionsHistoryConsolidated.getFailed();
            }
        }
        if (j11 != 0) {
