...
public final class v1 extends x1 {
    public static boolean s(Transition transition) {
        if (x1.h(transition.getTargetIds()) && x1.h(transition.getTargetNames()) && x1.h(transition.getTargetTypes())) {
            return false;
        }
        return true;
    }
    ...
    public final void b(Object obj, ArrayList arrayList) {
        ...
        if (!s(transition) && x1.h(transition.getTargets())) {
    ...
    @Override // androidx.fragment.app.x1
    public final void o(Object obj, y3.g gVar, h.m0 m0Var) {
        ((Transition) obj).addListener(new u1(m0Var));
    }
