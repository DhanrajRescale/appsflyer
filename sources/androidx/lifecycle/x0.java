...
public abstract class x0 {
    ...
    public static final List f1997a = vt.y.g(Application.class, r0.class);

    /* renamed from: b, reason: collision with root package name */
    public static final List f1998b = vt.x.a(r0.class);
    ...
    public static final Constructor a(Class modelClass, List signature) {
        ...
        for (Constructor<?> constructor : constructors) {
            ...
            List y10 = vt.v.y(parameterTypes);
            if (Intrinsics.a(signature, y10)) {
                return constructor;
            }
    ...
    public static final a1 b(Class modelClass, Constructor constructor, Object... params) {
        Intrinsics.checkNotNullParameter(modelClass, "modelClass");
