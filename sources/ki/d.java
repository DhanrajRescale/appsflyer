...
public final class d implements d0 {
    ...
    public final StockOrderDto f23202a;

    public d(StockOrderDto stockOrder) {
        Intrinsics.checkNotNullParameter(stockOrder, "stockOrder");
        this.f23202a = stockOrder;
    }
    ...
    public final Bundle a() {
        ...
        Parcelable parcelable = this.f23202a;
        if (isAssignableFrom) {
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof d) && Intrinsics.a(this.f23202a, ((d) obj).f23202a);
    }
    ...
    public final String toString() {
        return "StockSellTransactionPending(stockOrder=" + this.f23202a + ")";
    }
}
