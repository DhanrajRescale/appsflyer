...
public class zziy extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i11 = 0;
        if (i10 >= 0) {
            int compareTo = comparable.compareTo(((zzis) this.zzb.get(i10)).zza());
            if (compareTo > 0) {
                return -(size + 1);
            }
            if (compareTo == 0) {
        ...
        while (i11 <= i10) {
            int i12 = (i11 + i10) / 2;
            int compareTo2 = comparable.compareTo(((zzis) this.zzb.get(i12)).zza());
            if (compareTo2 < 0) {
                i10 = i12 - 1;
    ...
    public final boolean equals(Object obj) {
        ...
        if (zzb == zziyVar.zzb()) {
            for (int i10 = 0; i10 < zzb; i10++) {
                if (!zzg(i10).equals(zziyVar.zzg(i10))) {
                    return false;
                }
            }
            if (zzb == size) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i11 = this.zza;
        if (size == i11) {
            zzis zzisVar = (zzis) this.zzb.remove(i11 - 1);
