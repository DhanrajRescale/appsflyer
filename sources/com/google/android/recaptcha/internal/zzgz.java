...
public final class zzgz {
    ...
    static {
        ...
        zzc = zzgzVar3;
        zzgz zzgzVar4 = new zzgz("FLOAT", 3, Float.TYPE, Float.class, Float.valueOf(g.f34069a));
        zzd = zzgzVar4;
        ...
        zzf = zzgzVar6;
        zzgz zzgzVar7 = new zzgz("STRING", 6, String.class, String.class, HttpUrl.FRAGMENT_ENCODE_SET);
        zzg = zzgzVar7;
