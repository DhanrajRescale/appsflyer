...
public final class zzju {
    ...
    */
    ...
    public static String zzd(byte[] bArr, int i10, int i11) throws zzgy {
        ...
        if ((((length - i10) - i11) | i10 | i11) >= 0) {
            ...
            while (i10 < i12) {
                ...
                if (zzjq.zzd(b11)) {
                    ...
                    if (i15 < i12) {
                        i10 += 2;
                        zzjq.zzc(b11, bArr[i15], cArr, i14);
                        i14++;
                    } else {
                        throw zzgy.zzd();
                    }
                    ...
                    if (i15 < i12 - 1) {
                        int i16 = i10 + 2;
                        i10 += 3;
                        zzjq.zzb(b11, bArr[i15], bArr[i16], cArr, i14);
                        i14++;
                    } else {
                        throw zzgy.zzd();
                    }
                    ...
                    byte b14 = bArr[i10 + 2];
                    i10 += 4;
                    zzjq.zza(b11, b13, b14, bArr[i17], cArr, i14);
                    i14 += 2;
                } else {
                    throw zzgy.zzd();
                }
