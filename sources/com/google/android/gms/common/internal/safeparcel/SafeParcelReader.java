...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i10) {
        if (parcel.dataPosition() == i10) {
            ...
            throw new ParseException(h.n("Overread allowed size end=", i10), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (getFieldId(readHeader) == 20293) {
            ...
            throw new ParseException(e.m("Size read is invalid start=", dataPosition, " end=", i10), parcel);
        }
    ...
    private static void zza(Parcel parcel, int i10, int i11, int i12) {
        ...
        throw new ParseException(d.o(e.q("Expected size ", i12, " got ", i11, " (0x"), Integer.toHexString(i11), ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i10, int i11) {
        ...
        throw new ParseException(d.o(e.q("Expected size ", i11, " got ", readSize, " (0x"), Integer.toHexString(readSize), ")"), parcel);
    }
}
