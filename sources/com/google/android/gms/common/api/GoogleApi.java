...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    public <A extends Api.AnyClient, T extends RegisterListenerMethod<A, ?>, U extends UnregisterListenerMethod<A, ?>> Task<Void> doRegisterEventListener(@NonNull T t10, @NonNull U u10) {
        ...
        return this.zaa.zaq(this, t10, u10, new Runnable() { // from class: com.google.android.gms.common.api.zad
    ...
    */
    ...
    private GoogleApi(@NonNull Context context, Activity activity, Api<O> api, O o10, Settings settings) {
        ...
        ApiKey<O> zaa = ApiKey.zaa(api, o10, str);
        this.zaf = zaa;
