...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static GoogleSignInAccount fromAccount(@NonNull Account account) {
        return zae(account, new g());
    }

    @NonNull
    public static GoogleSignInAccount zaa(String str, String str2, String str3, String str4, String str5, String str6, Uri uri, Long l10, @NonNull String str7, @NonNull Set<Scope> set) {
    ...
    public int hashCode() {
        return getRequestedScopes().hashCode() + h.g(this.zak, 527, 31);
    }
