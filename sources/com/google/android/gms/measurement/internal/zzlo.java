...
public final class zzlo extends zzgy {
    ...
    public static void zzK(zziq zziqVar, Bundle bundle, boolean z10) {
    ...
    public static final boolean zzaq(Bundle bundle, int i10) {
    ...
    public final URL zzE(long j10, String str, String str2, long j11) {
        try {
            ...
            Preconditions.checkNotEmpty(str);
            String format = String.format("https://www.googleadservices.com/pagead/conversion/app/deeplink?id_type=adid&sdk_version=%s&rdid=%s&bundleid=%s&retry=%s", String.format("v%s.%s", 77000L, Integer.valueOf(zzm())), str2, str, Long.valueOf(j11));
    ...
    public final void zzM(Parcelable[] parcelableArr, int i10, boolean z10) {
        ...
        for (Parcelable parcelable : parcelableArr) {
            ...
            while (it.hasNext()) {
                ...
                if (zzak(str) && !zzau(str, zzhc.zzd) && (i11 = i11 + 1) > i10) {
                    if (z10) {
                        this.zzt.zzaA().zze().zzc(h.o("Param can't contain more than ", i10, " item-scoped custom parameters"), this.zzt.zzj().zze(str), this.zzt.zzj().zzb(bundle));
                        zzaq(bundle, 28);
                    } else {
    ...
    public final void zzN(zzev zzevVar, int i10) {
        Iterator it = new TreeSet(zzevVar.zzd.keySet()).iterator();
        int i11 = 0;
        while (it.hasNext()) {
            String str = (String) it.next();
            if (zzak(str) && (i11 = i11 + 1) > i10) {
                this.zzt.zzaA().zze().zzc(h.o("Event can't contain more than ", i10, " params"), this.zzt.zzj().zzd(zzevVar.zza), this.zzt.zzj().zzb(zzevVar.zzd));
                zzaq(zzevVar.zzd, 5);
    ...
    public final void zzO(zzln zzlnVar, String str, int i10, String str2, String str3, int i11) {
        Bundle bundle = new Bundle();
        zzaq(bundle, i10);
    ...
    public final void zzQ(com.google.android.gms.internal.measurement.zzcf zzcfVar, boolean z10) {
        try {
            zzcfVar.zze(h.h(MatchIndex.ROOT_VALUE, z10));
    ...
    public final void zzR(com.google.android.gms.internal.measurement.zzcf zzcfVar, ArrayList arrayList) {
        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList(MatchIndex.ROOT_VALUE, arrayList);
        try {
            zzcfVar.zze(bundle);
        } catch (RemoteException e10) {
    ...
    public final void zzT(com.google.android.gms.internal.measurement.zzcf zzcfVar, byte[] bArr) {
        Bundle bundle = new Bundle();
        bundle.putByteArray(MatchIndex.ROOT_VALUE, bArr);
        try {
            zzcfVar.zze(bundle);
        } catch (RemoteException e10) {
    ...
    public final void zzU(com.google.android.gms.internal.measurement.zzcf zzcfVar, int i10) {
        Bundle bundle = new Bundle();
        bundle.putInt(MatchIndex.ROOT_VALUE, i10);
        try {
            zzcfVar.zze(bundle);
        } catch (RemoteException e10) {
    ...
    public final void zzV(com.google.android.gms.internal.measurement.zzcf zzcfVar, long j10) {
        Bundle bundle = new Bundle();
        bundle.putLong(MatchIndex.ROOT_VALUE, j10);
        try {
            zzcfVar.zze(bundle);
        } catch (RemoteException e10) {
    ...
    public final void zzW(com.google.android.gms.internal.measurement.zzcf zzcfVar, String str) {
        Bundle bundle = new Bundle();
        bundle.putString(MatchIndex.ROOT_VALUE, str);
        try {
            zzcfVar.zze(bundle);
        } catch (RemoteException e10) {
    ...
    public final void zzX(String str, String str2, String str3, Bundle bundle, List list, boolean z10) {
        int i10;
        int i11;
        int i12;
        String str4;
        ...
        zzpn.zzc();
        String str7 = null;
        if (zzf.zzt.zzf().zzs(null, zzeh.zzaz) && zzf.zzt.zzv().zzai(231100000, true)) {
            i10 = 35;
        } else {
            i10 = 0;
        }
                    ...
                    if (!zzai(231100000, true)) {
                        ...
                        if (i16 > i14) {
                            ...
                            if (this.zzt.zzf().zzs(null, zzeh.zzaz)) {
                                this.zzt.zzaA().zze().zzc(h.o("Item can't contain more than ", i14, " item-scoped custom params"), this.zzt.zzj().zzd(str2), this.zzt.zzj().zzb(bundle));
                                zzaq(bundle, 28);
                                bundle.remove(str4);
                            } else {
    ...
    */
    ...
    public final void zzaC() {
        ...
        if (nextLong == 0) {
            ...
            if (nextLong == 0) {
                a.v(this.zzt, "Utils falling back to Random for random id");
            }
        }
    ...
    public final boolean zzai(int i10, boolean z10) {
        ...
        if (zzm() >= i10 / CredentialsApi.ACTIVITY_RESULT_ADD_ACCOUNT) {
            return true;
        }
    ...
    public final int zzm() {
        if (this.zzf == null) {
            this.zzf = Integer.valueOf(GoogleApiAvailabilityLight.getInstance().getApkVersion(this.zzt.zzaw()) / CredentialsApi.ACTIVITY_RESULT_ADD_ACCOUNT);
        }
