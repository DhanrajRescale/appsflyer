...
public final class zzli extends zzkt {
    ...
    public final long zzd(byte[] bArr) {
        ...
        if (zzF == null) {
            a.r(this.zzt, "Failed to get MD5");
            return 0L;
        }
    ...
    public final String zzm(com.google.android.gms.internal.measurement.zzgb zzgbVar) {
        ...
        for (com.google.android.gms.internal.measurement.zzgd zzgdVar : zzgbVar.zzd()) {
            if (zzgdVar != null) {
                ...
                p10.append("bundle {\n");
                if (zzgdVar.zzbl()) {
                    zzI(p10, 1, "protocol_version", Integer.valueOf(zzgdVar.zzd()));
                }
                zzqr.zzc();
                if (this.zzt.zzf().zzs(zzgdVar.zzy(), zzeh.zzao) && zzgdVar.zzbo()) {
                    zzI(p10, 1, "session_stitching_token", zzgdVar.zzL());
                }
                zzI(p10, 1, "platform", zzgdVar.zzJ());
                if (zzgdVar.zzbh()) {
                    zzI(p10, 1, "gmp_version", Long.valueOf(zzgdVar.zzm()));
                }
                if (zzgdVar.zzbt()) {
                    zzI(p10, 1, "uploading_gmp_version", Long.valueOf(zzgdVar.zzs()));
                }
                if (zzgdVar.zzbf()) {
                    zzI(p10, 1, "dynamite_version", Long.valueOf(zzgdVar.zzj()));
                }
                if (zzgdVar.zzbc()) {
                    zzI(p10, 1, "config_version", Long.valueOf(zzgdVar.zzh()));
                }
                zzI(p10, 1, "gmp_app_id", zzgdVar.zzG());
                zzI(p10, 1, "admob_app_id", zzgdVar.zzx());
                zzI(p10, 1, "app_id", zzgdVar.zzy());
                zzI(p10, 1, "app_version", zzgdVar.zzB());
                if (zzgdVar.zzba()) {
                    zzI(p10, 1, "app_version_major", Integer.valueOf(zzgdVar.zza()));
                }
                zzI(p10, 1, "firebase_instance_id", zzgdVar.zzF());
                if (zzgdVar.zzbe()) {
                    zzI(p10, 1, "dev_cert_hash", Long.valueOf(zzgdVar.zzi()));
                }
                zzI(p10, 1, "app_store", zzgdVar.zzA());
                if (zzgdVar.zzbs()) {
                    zzI(p10, 1, "upload_timestamp_millis", Long.valueOf(zzgdVar.zzr()));
                }
                if (zzgdVar.zzbp()) {
                    zzI(p10, 1, "start_timestamp_millis", Long.valueOf(zzgdVar.zzp()));
                }
                if (zzgdVar.zzbg()) {
                    zzI(p10, 1, "end_timestamp_millis", Long.valueOf(zzgdVar.zzk()));
                }
                if (zzgdVar.zzbk()) {
                    zzI(p10, 1, "previous_bundle_start_timestamp_millis", Long.valueOf(zzgdVar.zzo()));
                }
                if (zzgdVar.zzbj()) {
                    zzI(p10, 1, "previous_bundle_end_timestamp_millis", Long.valueOf(zzgdVar.zzn()));
                }
                zzI(p10, 1, "app_instance_id", zzgdVar.zzz());
                zzI(p10, 1, "resettable_device_id", zzgdVar.zzK());
                zzI(p10, 1, "ds_id", zzgdVar.zzE());
                if (zzgdVar.zzbi()) {
                    zzI(p10, 1, "limited_ad_tracking", Boolean.valueOf(zzgdVar.zzaY()));
                }
                zzI(p10, 1, "os_version", zzgdVar.zzI());
                zzI(p10, 1, "device_model", zzgdVar.zzD());
                zzI(p10, 1, "user_default_language", zzgdVar.zzM());
                if (zzgdVar.zzbr()) {
                    zzI(p10, 1, "time_zone_offset_minutes", Integer.valueOf(zzgdVar.zzf()));
                }
                if (zzgdVar.zzbb()) {
                    zzI(p10, 1, "bundle_sequential_index", Integer.valueOf(zzgdVar.zzb()));
                }
                if (zzgdVar.zzbn()) {
                    zzI(p10, 1, "service_upload", Boolean.valueOf(zzgdVar.zzaZ()));
                }
                zzI(p10, 1, "health_monitor", zzgdVar.zzH());
                if (zzgdVar.zzbm()) {
                    zzI(p10, 1, "retry_counter", Integer.valueOf(zzgdVar.zze()));
                }
                if (zzgdVar.zzbd()) {
                    zzI(p10, 1, "consent_signals", zzgdVar.zzC());
                }
                zzpw.zzc();
                if (this.zzt.zzf().zzs(null, zzeh.zzaE) && zzgdVar.zzbq()) {
                    zzI(p10, 1, "target_os_version", Long.valueOf(zzgdVar.zzq()));
                }
                ...
                if (zzP != null) {
                    for (com.google.android.gms.internal.measurement.zzgm zzgmVar : zzP) {
                        if (zzgmVar != null) {
                            zzF(p10, 2);
                            p10.append("user_property {\n");
                            if (zzgmVar.zzs()) {
                                l10 = Long.valueOf(zzgmVar.zzc());
                            } else {
                                l10 = null;
                            }
                            zzI(p10, 2, "set_timestamp_millis", l10);
                            zzI(p10, 2, AppMeasurementSdk.ConditionalUserProperty.NAME, this.zzt.zzj().zzf(zzgmVar.zzf()));
                            zzI(p10, 2, "string_value", zzgmVar.zzg());
                            if (zzgmVar.zzr()) {
                                l11 = Long.valueOf(zzgmVar.zzb());
                            } else {
                                l11 = null;
                            }
                            zzI(p10, 2, "int_value", l11);
                            if (zzgmVar.zzq()) {
                                d10 = Double.valueOf(zzgmVar.zza());
                            } else {
                                d10 = null;
                            }
                            zzI(p10, 2, "double_value", d10);
                            zzF(p10, 2);
                            p10.append("}\n");
                        }
                    }
                ...
                if (zzN != null) {
                    for (com.google.android.gms.internal.measurement.zzfp zzfpVar : zzN) {
                        if (zzfpVar != null) {
                            zzF(p10, 2);
                            p10.append("audience_membership {\n");
                            if (zzfpVar.zzk()) {
                                zzI(p10, 2, "audience_id", Integer.valueOf(zzfpVar.zza()));
                            }
                            if (zzfpVar.zzm()) {
                                zzI(p10, 2, "new_audience", Boolean.valueOf(zzfpVar.zzj()));
                            }
                            zzH(p10, 2, "current_data", zzfpVar.zzd());
                            if (zzfpVar.zzn()) {
                                zzH(p10, 2, "previous_data", zzfpVar.zze());
                            }
                            zzF(p10, 2);
                            p10.append("}\n");
                        }
                ...
                if (zzO != null) {
                    for (com.google.android.gms.internal.measurement.zzft zzftVar : zzO) {
                        if (zzftVar != null) {
                            zzF(p10, 2);
                            p10.append("event {\n");
                            zzI(p10, 2, AppMeasurementSdk.ConditionalUserProperty.NAME, this.zzt.zzj().zzd(zzftVar.zzh()));
                            if (zzftVar.zzu()) {
                                zzI(p10, 2, "timestamp_millis", Long.valueOf(zzftVar.zzd()));
                            }
                            if (zzftVar.zzt()) {
                                zzI(p10, 2, "previous_timestamp_millis", Long.valueOf(zzftVar.zzc()));
                            }
                            if (zzftVar.zzs()) {
                                zzI(p10, 2, "count", Integer.valueOf(zzftVar.zza()));
                            }
                            if (zzftVar.zzb() != 0) {
                                zzD(p10, 2, zzftVar.zzi());
                            }
                            zzF(p10, 2);
                            p10.append("}\n");
                        }
    ...
    public final String zzo(com.google.android.gms.internal.measurement.zzek zzekVar) {
        ...
        StringBuilder p10 = e.p("\nevent_filter {\n");
        if (zzekVar.zzp()) {
            zzI(p10, 0, "filter_id", Integer.valueOf(zzekVar.zzb()));
        }
        zzI(p10, 0, "event_name", this.zzt.zzj().zzd(zzekVar.zzg()));
        String zzG = zzG(zzekVar.zzk(), zzekVar.zzm(), zzekVar.zzn());
        if (!zzG.isEmpty()) {
            zzI(p10, 0, "filter_type", zzG);
        }
        if (zzekVar.zzo()) {
            zzJ(p10, 1, "event_count_filter", zzekVar.zzf());
        }
        if (zzekVar.zza() > 0) {
            p10.append("  filters {\n");
            Iterator it = zzekVar.zzh().iterator();
            while (it.hasNext()) {
                zzE(p10, 2, (com.google.android.gms.internal.measurement.zzem) it.next());
            }
        }
        zzF(p10, 1);
        p10.append("}\n}\n");
    ...
    public final String zzp(com.google.android.gms.internal.measurement.zzet zzetVar) {
        ...
        StringBuilder p10 = e.p("\nproperty_filter {\n");
        if (zzetVar.zzj()) {
            zzI(p10, 0, "filter_id", Integer.valueOf(zzetVar.zza()));
        }
        zzI(p10, 0, "property_name", this.zzt.zzj().zzf(zzetVar.zze()));
        String zzG = zzG(zzetVar.zzg(), zzetVar.zzh(), zzetVar.zzi());
        if (!zzG.isEmpty()) {
            zzI(p10, 0, "filter_type", zzG);
        }
        zzE(p10, 1, zzetVar.zzb());
        p10.append("}\n");
        return p10.toString();
    }
    ...
    */
    public final java.util.Map zzs(android.os.Bundle r11, boolean r12) {
        ...
        L84:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzli.zzs(android.os.Bundle, boolean):java.util.Map");
    }
