    ...
    public final /* bridge */ /* synthetic */ Object call() throws Exception {
        ...
        try {
            ...
            if (zzj == null) {
                ...
                zzu.zzad(1);
                zzu.zzZ(LogSubCategory.LifeCycle.ANDROID);
                ...
                try {
                    ...
                    if (zzllVar == null || zzllVar.zze == null) {
                        zzll zzllVar2 = new zzll(zzu2, "auto", "_lte", zzr.zzt.zzax().currentTimeMillis(), 0L);
                        zzu3.add(zzllVar2);
                    ...
                    for (int i10 = 0; i10 < zzu3.size(); i10++) {
                        ...
                        zzd2.zzf(((zzll) zzu3.get(i10)).zzc);
                        zzd2.zzg(((zzll) zzu3.get(i10)).zzd);
                        zzr.zzf.zzu().zzu(zzd2, ((zzll) zzu3.get(i10)).zze);
                    ...
                    try {
                        ...
                        zzr.zzt.zzaA().zzd().zzc("Data loss. Failed to bundle and serialize. appId", zzeu.zzn(str4), e11);
                        return str2;
                    }
