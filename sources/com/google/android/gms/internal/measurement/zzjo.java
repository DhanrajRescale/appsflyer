...
public final class zzjo {
    ...
    public static int zzd(zzmt zzmtVar, byte[] bArr, int i10, int i11, zzjn zzjnVar) throws IOException {
        Object zze = zzmtVar.zze();
    ...
    public static int zzg(byte[] bArr, int i10, zzjn zzjnVar) throws zzll {
        ...
        if (i11 >= 0) {
            if (i11 == 0) {
                zzjnVar.zzc = HttpUrl.FRAGMENT_ENCODE_SET;
                return zzj;
            }
            ...
            if ((((length - zzj) - i11) | zzj | i11) >= 0) {
                ...
                while (zzj < i13) {
                    ...
                    if (zznv.zzd(b11)) {
                        ...
                        if (i16 < i13) {
                            zzj += 2;
                            zznv.zzc(b11, bArr[i16], cArr, i15);
                            i15++;
                        } else {
                            throw zzll.zzc();
                        }
                        ...
                        if (i16 < i13 - 1) {
                            int i17 = zzj + 2;
                            zzj += 3;
                            zznv.zzb(b11, bArr[i16], bArr[i17], cArr, i15);
                            i15++;
                        } else {
                            throw zzll.zzc();
                        }
                        ...
                        byte b14 = bArr[zzj + 2];
                        zzj += 4;
                        zznv.zza(b11, b13, b14, bArr[i18], cArr, i15);
                        i15 += 2;
                    } else {
                        throw zzll.zzc();
                    }
                }
                zzjnVar.zzc = new String(cArr, 0, i15);
                return i13;
            }
