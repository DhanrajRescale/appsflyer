...
public final class zzlm {
    ...
    static {
        ...
        zzc = zzlmVar3;
        zzlm zzlmVar4 = new zzlm("FLOAT", 3, Float.TYPE, Float.class, Float.valueOf(g.f34069a));
        zzd = zzlmVar4;
        ...
        zzf = zzlmVar6;
        zzlm zzlmVar7 = new zzlm("STRING", 6, String.class, String.class, HttpUrl.FRAGMENT_ENCODE_SET);
        zzg = zzlmVar7;
