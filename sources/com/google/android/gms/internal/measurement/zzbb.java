        ...
        switch (c10) {
            ...
            case 4:
                ...
                while (zzk3.hasNext()) {
                    ...
                    double d13 = intValue;
                    if (d13 >= d10 && zzh.zzl(zzaeVar.zze(intValue), zzapVar)) {
            ...
            case 6:
                ...
                if (list.size() > 1) {
                    ...
                    d12 = Double.isNaN(zzb7.zzh().doubleValue()) ? zzaeVar.zzc() - 1 : zzh.zza(zzb7.zzh().doubleValue());
                    d11 = 0.0d;
                    if (d12 < 0.0d) {
                        d12 += zzaeVar.zzc();
                    }
                ...
                for (int min2 = (int) Math.min(zzaeVar.zzc(), d12); min2 >= 0; min2--) {
