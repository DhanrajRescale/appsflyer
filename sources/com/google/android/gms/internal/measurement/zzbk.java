...
public final class zzbk extends zzaw {
    ...
    public final zzap zza(String str, zzg zzgVar, List list) {
        ...
        if (ordinal != 3) {
                ...
                if (ordinal != 24) {
                    if (ordinal != 33) {
                        if (ordinal != 49) {
                                ...
                                if (ordinal != 17) {
                                    if (ordinal != 18) {
                                        if (ordinal != 35 && ordinal != 36) {
                                            switch (ordinal) {
                                                case 62:
                                                    zzap zzb = zzgVar.zzb((zzap) a.k(zzbl.TYPEOF, 1, list, 0));
                                        ...
                                        zzap zzb3 = zzgVar.zzb((zzap) a.k(zzbl.GET_PROPERTY, 2, list, 0));
                            ...
                            zzap zzb8 = zzgVar.zzb((zzap) a.k(zzbl.SET_PROPERTY, 3, list, 0));
                    ...
                    zzap zzb11 = zzgVar.zzb((zzap) a.k(zzbl.GET, 1, list, 0));
            ...
            if (list.size() % 2 == 0) {
                while (i10 < list.size() - 1) {
                    zzap zzb12 = zzgVar.zzb((zzap) list.get(i10));
                    if (zzb12 instanceof zzat) {
                        zzgVar.zzf(zzb12.zzi(), zzgVar.zzb((zzap) list.get(i10 + 1)));
                        i10 += 2;
                    } else {
        ...
        zzap zzb13 = zzgVar.zzb((zzap) a.k(zzbl.ASSIGN, 2, list, 0));
