        ...
        if (i10 == -1) {
            ...
            for (int i12 = 0; i12 < this.zzb; i12++) {
                ...
                if (i15 != 0) {
                    if (i15 != 1) {
                        if (i15 != 2) {
                            if (i15 != 3) {
                                ...
                                int i16 = i14 << 3;
                                int i17 = zzki.zzb;
                                int zza2 = ((zznl) this.zzd[i12]).zza();
                                int zzx = zzki.zzx(i16);
                                i11 = zzx + zzx + zza2 + i11;
                            }
                        } else {
                            zzka zzkaVar = (zzka) this.zzd[i12];
                            int i18 = zzki.zzb;
                            int zzd = zzkaVar.zzd();
                            i11 = a.w(i14 << 3, zzki.zzx(zzd) + zzd, i11);
                        }
                    } else {
                    ...
                    i11 = a.w(i14 << 3, zzki.zzy(((Long) this.zzd[i12]).longValue()), i11);
                }
            }
            this.zze = i11;
            return i11;
    ...
    public final int zzb() {
        ...
        if (i10 == -1) {
            ...
            for (int i12 = 0; i12 < this.zzb; i12++) {
                ...
                int zzx4 = zzki.zzx(8);
                i11 = a.x(24, zzx, zzx2 + zzx3 + zzx4 + zzx4, i11);
            }
            this.zze = i11;
            return i11;
        }
