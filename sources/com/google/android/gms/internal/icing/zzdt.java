...
final class zzdt extends zzbt<Long> implements RandomAccess, zzdf, zzel {
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < this.zzc; i11++) {
            i10 = (i10 * 31) + zzdh.zze(this.zzb[i11]);
        }
        return i10;
    }
    ...
    public final /* bridge */ /* synthetic */ zzdg<Long> zze(int i10) {
        if (i10 >= this.zzc) {
            return new zzdt(Arrays.copyOf(this.zzb, i10), this.zzc);
        }
        throw new IllegalArgumentException();
    }

    public final long zzf(int i10) {
        zzg(i10);
        return this.zzb[i10];
    }

    private zzdt(long[] jArr, int i10) {
        this.zzb = jArr;
        this.zzc = i10;
    }
    ...
    public final /* bridge */ /* synthetic */ boolean add(Object obj) {
        ...
        long[] jArr = this.zzb;
        if (i10 == jArr.length) {
            long[] jArr2 = new long[e.b(i10, 3, 2, 1)];
            System.arraycopy(jArr, 0, jArr2, 0, i10);
            this.zzb = jArr2;
        }
        long[] jArr3 = this.zzb;
