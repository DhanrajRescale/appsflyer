...
public final class zzdk {
    ...
    static {
        ...
        zzc = zzdkVar3;
        zzdk zzdkVar4 = new zzdk("FLOAT", 3, Float.TYPE, Float.class, Float.valueOf(g.f34069a));
        zzd = zzdkVar4;
        ...
        zzf = zzdkVar6;
        zzdk zzdkVar7 = new zzdk("STRING", 6, String.class, String.class, HttpUrl.FRAGMENT_ENCODE_SET);
        zzg = zzdkVar7;
    ...
    private zzdk(String str, int i10, Class cls, Class cls2, Object obj) {
        this.zzk = cls;
        this.zzl = cls2;
        this.zzm = obj;
    }
