...
public final class zzahy extends zzaeq implements RandomAccess {
    ...
    public final /* bridge */ /* synthetic */ zzagp zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzahy(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
        throw new IllegalArgumentException();
    }

    private zzahy(Object[] objArr, int i10, boolean z10) {
        super(z10);
        this.zzb = objArr;
        this.zzc = i10;
    }
