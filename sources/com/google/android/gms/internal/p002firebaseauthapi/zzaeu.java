...
final class zzaeu extends zzaeq implements RandomAccess, zzagp, zzahw {
    ...
    public final /* synthetic */ void add(int i10, Object obj) {
        ...
        if (i10 >= 0 && i10 <= (i11 = this.zzc)) {
            ...
            if (i11 < zArr.length) {
                ...
                boolean[] zArr2 = new boolean[v.e.b(i11, 3, 2, 1)];
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < this.zzc; i11++) {
            i10 = (i10 * 31) + zzagq.zza(this.zzb[i11]);
        }
        return i10;
    }
    ...
    public final /* bridge */ /* synthetic */ zzagp zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzaeu(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    public final void zze(boolean z10) {
        ...
        boolean[] zArr = this.zzb;
        if (i10 == zArr.length) {
            boolean[] zArr2 = new boolean[v.e.b(i10, 3, 2, 1)];
            System.arraycopy(zArr, 0, zArr2, 0, i10);
            this.zzb = zArr2;
        }
    ...
    private zzaeu(boolean[] zArr, int i10, boolean z10) {
        super(z10);
        this.zzb = zArr;
        this.zzc = i10;
    }
