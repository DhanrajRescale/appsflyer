...
final class zzahe extends zzaeq implements RandomAccess, zzagp, zzahw {
    ...
    public final /* synthetic */ void add(int i10, Object obj) {
        ...
        if (i10 >= 0 && i10 <= (i11 = this.zzc)) {
            ...
            if (i11 < jArr.length) {
                ...
                long[] jArr2 = new long[v.e.b(i11, 3, 2, 1)];
    ...
    public final /* bridge */ /* synthetic */ zzagp zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzahe(Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    public final void zzf(long j10) {
        ...
        long[] jArr = this.zzb;
        if (i10 == jArr.length) {
            long[] jArr2 = new long[v.e.b(i10, 3, 2, 1)];
            System.arraycopy(jArr, 0, jArr2, 0, i10);
            this.zzb = jArr2;
        }
        long[] jArr3 = this.zzb;
    ...
    private zzahe(long[] jArr, int i10, boolean z10) {
        super(z10);
        this.zzb = jArr;
        this.zzc = i10;
    }
