...
public final class zzaag {
    ...
    */
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzaag.zza(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }

    /* JADX WARN: Type inference failed for: r0v2, types: [com.google.firebase.FirebaseException, com.google.firebase.auth.FirebaseAuthException, com.google.firebase.auth.FirebaseAuthUserCollisionException] */
    public static FirebaseException zzb(Status status, d dVar, String str, String str2) {
        int statusCode = status.getStatusCode();
        if (statusCode != 17012 && statusCode != 17007 && statusCode != 17025) {
            return zza(status);
        }
        ?? firebaseAuthException = new FirebaseAuthException(zzc(statusCode), zzd(zze(statusCode), status));
        firebaseAuthException.f11652b = dVar;
        firebaseAuthException.f11653c = str;
    ...
    private static String zzd(String str, Status status) {
        ...
        return String.format(valueOf.concat(" [ %s ]"), status.getStatusMessage());
    }
