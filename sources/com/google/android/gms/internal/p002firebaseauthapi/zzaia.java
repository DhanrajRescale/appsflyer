...
interface zzaia {
    ...
    @Deprecated
    void zzC(List list, zzaib zzaibVar, zzafx zzafxVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzaib zzaibVar, zzafx zzafxVar) throws IOException;
    ...
    void zzt(Object obj, zzaib zzaibVar, zzafx zzafxVar) throws IOException;

    void zzu(Object obj, zzaib zzaibVar, zzafx zzafxVar) throws IOException;
