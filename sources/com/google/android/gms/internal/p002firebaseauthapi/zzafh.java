...
public final class zzafh extends zzafl {
    ...
    public /* synthetic */ zzafh(byte[] bArr, int i10, int i11, boolean z10, zzafg zzafgVar) {
        super(null);
    ...
    public final zzaff zzw() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i11 = this.zzh;
            if (zzj <= i10 - i11) {
                zzaff zzn = zzaff.zzn(this.zze, i11, zzj);
                this.zzh += zzj;
                return zzn;
            }
        }
        if (zzj != 0) {
            if (zzj > 0) {
                ...
                if (zzj <= i12 - i13) {
                    int i14 = zzj + i13;
                    this.zzh = i14;
                    return new zzafc(Arrays.copyOfRange(this.zze, i13, i14));
                }
            }
            if (zzj <= 0) {
                throw zzags.zzf();
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i11 = this.zzh;
            if (zzj <= i10 - i11) {
                String str = new String(this.zze, i11, zzj, zzagq.zzb);
                this.zzh += zzj;
                return str;
            }
        }
    ...
    public final String zzy() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i11 = this.zzh;
            if (zzj <= i10 - i11) {
                String zzd = zzajk.zzd(this.zze, i11, zzj);
                this.zzh += zzj;
                return zzd;
            }
        }
