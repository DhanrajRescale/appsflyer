...
public abstract class zzafl {
    ...
    public static zzafl zzH(byte[] bArr, int i10, int i11, boolean z10) {
        zzafh zzafhVar = new zzafh(bArr, 0, i11, z10, null);
        try {
            zzafhVar.zze(i11);
            return zzafhVar;
        } catch (zzags e10) {
    ...
    public abstract int zze(int i10) throws zzags;
    ...
    public abstract void zzz(int i10) throws zzags;
}
