...
public final /* data */ class StockAnalysisBvpsConfigDto implements StockAnalysisCalculationType {
    ...
    @SerializedName("estimated_pb_config")
    @NotNull
    ...
    public StockAnalysisBvpsConfigDto(@NotNull StockAnalysisInputConfigDto cagrInEps, @NotNull StockAnalysisInputConfigDto discountPercentage, @NotNull StockAnalysisInputConfigDto estimatedPE, float f10, float f11) {
    ...
    public static /* synthetic */ StockAnalysisBvpsConfigDto copy$default(StockAnalysisBvpsConfigDto stockAnalysisBvpsConfigDto, StockAnalysisInputConfigDto stockAnalysisInputConfigDto, StockAnalysisInputConfigDto stockAnalysisInputConfigDto2, StockAnalysisInputConfigDto stockAnalysisInputConfigDto3, float f10, float f11, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            stockAnalysisInputConfigDto = stockAnalysisBvpsConfigDto.cagrInEps;
        }
        if ((i10 & 2) != 0) {
            stockAnalysisInputConfigDto2 = stockAnalysisBvpsConfigDto.discountPercentage;
        }
        StockAnalysisInputConfigDto stockAnalysisInputConfigDto4 = stockAnalysisInputConfigDto2;
        if ((i10 & 4) != 0) {
            stockAnalysisInputConfigDto3 = stockAnalysisBvpsConfigDto.estimatedPE;
        }
        StockAnalysisInputConfigDto stockAnalysisInputConfigDto5 = stockAnalysisInputConfigDto3;
        if ((i10 & 8) != 0) {
            f10 = stockAnalysisBvpsConfigDto.ttmEPS;
        }
        float f12 = f10;
        if ((i10 & 16) != 0) {
            f11 = stockAnalysisBvpsConfigDto.cmp;
        }
        return stockAnalysisBvpsConfigDto.copy(stockAnalysisInputConfigDto, stockAnalysisInputConfigDto4, stockAnalysisInputConfigDto5, f12, f11);
    }
    ...
    @NotNull
    public final StockAnalysisBvpsConfigDto copy(@NotNull StockAnalysisInputConfigDto cagrInEps, @NotNull StockAnalysisInputConfigDto discountPercentage, @NotNull StockAnalysisInputConfigDto estimatedPE, float ttmEPS, float cmp) {
        Intrinsics.checkNotNullParameter(cagrInEps, "cagrInEps");
        Intrinsics.checkNotNullParameter(discountPercentage, "discountPercentage");
        Intrinsics.checkNotNullParameter(estimatedPE, "estimatedPE");
        return new StockAnalysisBvpsConfigDto(cagrInEps, discountPercentage, estimatedPE, ttmEPS, cmp);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof StockAnalysisBvpsConfigDto)) {
            return false;
        }
        StockAnalysisBvpsConfigDto stockAnalysisBvpsConfigDto = (StockAnalysisBvpsConfigDto) other;
        return Intrinsics.a(this.cagrInEps, stockAnalysisBvpsConfigDto.cagrInEps) && Intrinsics.a(this.discountPercentage, stockAnalysisBvpsConfigDto.discountPercentage) && Intrinsics.a(this.estimatedPE, stockAnalysisBvpsConfigDto.estimatedPE) && Float.compare(this.ttmEPS, stockAnalysisBvpsConfigDto.ttmEPS) == 0 && Float.compare(this.cmp, stockAnalysisBvpsConfigDto.cmp) == 0;
    }
    ...
    public String toString() {
        return "StockAnalysisBvpsConfigDto(cagrInEps=" + this.cagrInEps + ", discountPercentage=" + this.discountPercentage + ", estimatedPE=" + this.estimatedPE + ", ttmEPS=" + this.ttmEPS + ", cmp=" + this.cmp + ")";
    }
}
