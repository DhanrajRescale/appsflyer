...
public final /* data */ class AddComponentDto implements Parcelable {
    ...
    public static final class Creator implements Parcelable.Creator<AddComponentDto> {
        ...
        @NotNull
        public final AddComponentDto createFromParcel(@NotNull Parcel parcel) {
    ...
    public AddComponentDto(@NotNull String name) {
    ...
    @NotNull
    public final AddComponentDto copy(@NotNull String name) {
        Intrinsics.checkNotNullParameter(name, "name");
        return new AddComponentDto(name);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof AddComponentDto) && Intrinsics.a(this.name, ((AddComponentDto) other).name);
    }
    ...
    public String toString() {
        return d.k("AddComponentDto(name=", this.name, ")");
    }
