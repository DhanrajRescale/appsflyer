...
public final /* data */ class PlatformMeta implements Parcelable {
    ...
    public static final class Creator implements Parcelable.Creator<PlatformMeta> {
        ...
        @NotNull
        public final PlatformMeta createFromParcel(@NotNull Parcel parcel) {
    ...
    @NotNull
    public final PlatformMeta copy(String userName, String email, String platform) {
        return new PlatformMeta(userName, email, platform);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PlatformMeta)) {
            return false;
        }
        PlatformMeta platformMeta = (PlatformMeta) other;
        return Intrinsics.a(this.userName, platformMeta.userName) && Intrinsics.a(this.email, platformMeta.email) && Intrinsics.a(this.platform, platformMeta.platform);
    }
    ...
    public String toString() {
        String str = this.userName;
        String str2 = this.email;
        return d.o(e.l("PlatformMeta(userName=", str, ", email=", str2, ", platform="), this.platform, ")");
    }
