...
public final /* data */ class Scheme extends TreeNode {
    ...
    public Scheme(@NotNull String id2) {
        super(id2, new NodeMetadata((byte) 2, id2));
    ...
    @NotNull
    public final Scheme copy(@NotNull String id2) {
        Intrinsics.checkNotNullParameter(id2, "id");
        return new Scheme(id2);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof Scheme) && Intrinsics.a(getId(), ((Scheme) other).getId());
    }
