...
public final /* data */ class Host extends TreeNode {
    ...
    public Host(@NotNull String id2) {
        super(id2, new NodeMetadata((byte) 4, id2));
    ...
    @NotNull
    public final Host copy(@NotNull String id2) {
        Intrinsics.checkNotNullParameter(id2, "id");
        return new Host(id2);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof Host) && Intrinsics.a(getId(), ((Host) other).getId());
    }
