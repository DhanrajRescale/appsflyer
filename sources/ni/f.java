...
public final class f extends gd.o {
    ...
    public static final /* synthetic */ int f28730z = 0;

    /* renamed from: x, reason: collision with root package name */
    public final boolean f28731x;

    /* renamed from: y, reason: collision with root package name */
    public final l f28732y;
    ...
    */
    public f(androidx.recyclerview.widget.RecyclerView r5, boolean r6, ni.l r7) {
        /*
            r4 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ni.f.<init>(androidx.recyclerview.widget.RecyclerView, boolean, ni.l):void");
    }
    ...
    public final void x() {
        ...
        stockItemViewModel.f10245g.observe(this, new li.c(5, new e(this, 0)));
        StockItemViewModel stockItemViewModel2 = (StockItemViewModel) v();
        stockItemViewModel2.f10246h.observe(this, new li.c(5, new e(this, 1)));
        StockItemViewModel stockItemViewModel3 = (StockItemViewModel) v();
        stockItemViewModel3.f10247i.observe(this, new li.c(5, new e(this, 2)));
        StockItemViewModel stockItemViewModel4 = (StockItemViewModel) v();
        stockItemViewModel4.f10248j.observe(this, new li.c(5, new e(this, 3)));
        StockItemViewModel stockItemViewModel5 = (StockItemViewModel) v();
        stockItemViewModel5.f10249k.observe(this, new li.c(5, new e(this, 4)));
    }

    @Override // gd.o
    public final void y(View view) {
        Intrinsics.checkNotNullParameter(view, "view");
        view.setOnClickListener(new ph.a(this, 6));
    }
}
