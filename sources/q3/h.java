...
public abstract class h extends r3.k {

    /* renamed from: a, reason: collision with root package name */
    public static final /* synthetic */ int f31615a = 0;
    ...
    public static void a(Activity activity, String[] strArr, int i10) {
        ...
        for (int i11 = 0; i11 < strArr.length; i11++) {
            if (!TextUtils.isEmpty(strArr[i11])) {
                ...
                throw new IllegalArgumentException(nn.d.o(new StringBuilder("Permission request for permissions "), Arrays.toString(strArr), " must not contain null or empty values"));
            }
        }
