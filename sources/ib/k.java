...
public final class k extends iu.k implements hu.c {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ RiaProfileActivity f19795a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ qu.f0 f19796b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ w4 f19797c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k(RiaProfileActivity riaProfileActivity, qu.f0 f0Var, w4 w4Var) {
        super(3);
        this.f19795a = riaProfileActivity;
        this.f19796b = f0Var;
        this.f19797c = w4Var;
    }
    ...
    public final Object b(Object obj, Object obj2, Object obj3) {
        ...
        RiaProfileActivity riaProfileActivity = this.f19795a;
        ...
        String str2 = str;
        qu.f0 f0Var = this.f19796b;
        w4 w4Var = this.f19797c;
        yk.j.e(str2, false, new h(riaProfileActivity, f0Var, w4Var, 0), new j(0, w4Var, f0Var), nVar, 0, 2);
        return Unit.f23355a;
    }
}
