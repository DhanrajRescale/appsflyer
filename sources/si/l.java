...
public final class l implements d0 {
    ...
    public final Bundle a() {
        ...
        Parcelable parcelable = this.f34657a;
        if (isAssignableFrom) {
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof l) && Intrinsics.a(this.f34657a, ((l) obj).f34657a);
    }
    ...
    public final String toString() {
        return "TransactionPending(stockOrder=" + this.f34657a + ")";
    }
}
