...
public final class i extends au.i implements Function2 {
    ...
    public final /* synthetic */ VideoPlayer f16129b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i(VideoPlayer videoPlayer, yt.a aVar) {
        super(2, aVar);
        this.f16129b = videoPlayer;
    }

    @Override // au.a
    public final yt.a create(Object obj, yt.a aVar) {
        return new i(this.f16129b, aVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            n.b(obj);
            this.f16128a = 1;
            if (VideoPlayer.a(this.f16129b, this) == aVar) {
                return aVar;
            }
        }
        return Unit.f23355a;
