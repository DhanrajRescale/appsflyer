...
import com.assetgro.stockgro.ui.profile.adapter.FollowerFollowingInnerItemViewModel;
import gd.o;
    ...
    */
    public b(androidx.recyclerview.widget.RecyclerView r5, kotlin.jvm.functions.Function1 r6) {
        /*
            ...
            java.lang.String r1 = "onInnerItemClick"
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ch.b.<init>(androidx.recyclerview.widget.RecyclerView, kotlin.jvm.functions.Function1):void");
    }
    ...
    public final void x() {
        super.x();
        ((FollowerFollowingInnerItemViewModel) v()).f9075c.observe(this, new xf.v(29, new qg.a(this, 5)));
    }
